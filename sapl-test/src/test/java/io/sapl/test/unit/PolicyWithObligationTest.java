...
public class PolicyWithObligationTest {
	...
	public void test_policyWithObligation() {
		...
		AuthorizationDecision decision = new AuthorizationDecision(Decision.PERMIT, null, com.google.common.base.Optional.of(mapper.createArrayNode().set(0, obligation)), null);
