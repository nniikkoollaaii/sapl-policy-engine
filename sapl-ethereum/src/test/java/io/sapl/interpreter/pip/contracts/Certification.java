...
public class Certification extends Contract {
	...
	@Deprecated
	protected Certification(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice,
			BigInteger gasLimit) {
	...
	@Deprecated
	protected Certification(String contractAddress, Web3j web3j, TransactionManager transactionManager,
	...
	public RemoteFunctionCall<Boolean> hasCertificate(String graduate, String certificateIssuer,
	...
	@Deprecated
	public static Certification load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice,
			BigInteger gasLimit) {
		return new Certification(contractAddress, web3j, credentials, gasPrice, gasLimit);
	}

	@Deprecated
	public static Certification load(String contractAddress, Web3j web3j, TransactionManager transactionManager,
			BigInteger gasPrice, BigInteger gasLimit) {
	...
	public static RemoteCall<Certification> deploy(Web3j web3j, TransactionManager transactionManager,
			ContractGasProvider contractGasProvider) {
		return deployRemoteCall(Certification.class, web3j, transactionManager, contractGasProvider, BINARY, "");
	}

	@Deprecated
	public static RemoteCall<Certification> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice,
			BigInteger gasLimit) {
